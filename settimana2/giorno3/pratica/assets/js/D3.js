...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  //characters[i] = starWarsCharacters[i].name; //--->> si poteva fare anche senza push
}
...
/* ESERCIZIO 4
  Crea un oggetto "eyeColor" che abbia le seguenti proprietà: blue, yellow, brown, red, blueGray.
...
for (let i = 0; i < starWarsCharacters.length; i++) {  //---------->>> questo è sbagliato perchè non ho usato while
...
while (conta <  starWarsCharacters.length){
  crewMass1 += starWarsCharacters[conta].mass;
  conta++
}
...
} else if (crewMass1 > 900) {
  console.log("Critical Load: Over 900");
} else if (crewMass1 > 700) {
  console.log("Warning: Load is over 700");
} else if (crewMass1 > 500) {
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  while (starWarsCharacters[i].gender === "n/a") {
...
console.log('Il personaggio estratto è ', elemento.name);
console.log('Queste sono le sue caratteristiche:');
